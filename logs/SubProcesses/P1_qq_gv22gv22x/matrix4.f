...
C     ----------
      ...
      CALL OXXXXX(P(0,3),MDL_MGV22,NHEL(3),+1*IC(3),W(1,3))
      CALL IXXXXX(P(0,4),MDL_MGV22,NHEL(4),-1*IC(4),W(1,4))
      CALL FFS3_3(W(1,1),W(1,3),GC_21,MDL_MSS22,MDL_MWSS22,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL FFS1_0(W(1,4),W(1,2),W(1,5),GC_21,AMP(1))
