...
C     ----------
      ...
      CALL OXXXXX(P(0,3),MDL_MGV21,NHEL(3),+1*IC(3),W(1,3))
      CALL IXXXXX(P(0,4),MDL_MGV21,NHEL(4),-1*IC(4),W(1,4))
      CALL FFS3_3(W(1,1),W(1,3),GC_21,MDL_MSS21,MDL_MWSS21,W(1,5))
